...
class AxoniqConsoleConfigurerModule(
    ...
    override fun configureModule(configurer: Configurer) {
        ...
        configurer
            ...
            .registerComponent(AxoniqConsoleRSocketClient::class.java) {
            ...
            .registerComponent(ServerProcessorReporter::class.java) {
                ServerProcessorReporter(
                    it.getComponent(AxoniqConsoleRSocketClient::class.java),
                    it.getComponent(ProcessorReportCreator::class.java),
                    executor,
                )
            }
            ...
            .registerDefaultHandlerInterceptor { config, name ->
                AxoniqConsoleProcessorInterceptor(
        ...
        if (configureSpanFactory) {
            configurer.registerComponent(SpanFactory::class.java) { AxoniqConsoleSpanFactory() }
        }
        ...
        configurer.onStart {
            ...
            val interceptor = AxoniqConsoleDispatchInterceptor(
