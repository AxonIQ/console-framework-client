...
class AxoniqConsoleDispatchInterceptor(
        ...
        return BiFunction { _, message ->
            ...
            if (!CurrentUnitOfWork.isStarted()) {
                ...
                val origin = when {
                    ...
                    payload?.javaClass?.isAnnotationPresent(AxoniqConsoleMessageOrigin::class.java) == true -> payload.javaClass.getAnnotation(AxoniqConsoleMessageOrigin::class.java).name
                    else -> componentName
                }
